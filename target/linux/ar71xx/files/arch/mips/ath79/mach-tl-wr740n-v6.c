/*
 *  TL-WR740N/ND v6 adapted from TL-WR841N/ND v9
 *
...
#define TL_WR740NV6_KEYS_POLL_INTERVAL	20	/* msecs */
#define TL_WR740NV6_KEYS_DEBOUNCE_INTERVAL (3 * TL_WR740NV6_KEYS_POLL_INTERVAL)

static const char *tl_wr740n_v6_part_probes[] = {
	"tp-link",
	NULL,
};

static struct flash_platform_data tl_wr740n_v6_flash_data = {
	.part_probes	= tl_wr740n_v6_part_probes,
};
...
static struct gpio_keys_button tl_wr740n_v6_gpio_keys[] __initdata = {
	{
		...
		.type		= EV_KEY,
		.code		= KEY_RESTART,
		.debounce_interval = TL_WR740NV6_KEYS_DEBOUNCE_INTERVAL,
...
static void __init tl_ap143_setup(void)
{
	...
	ath79_register_m25p80(&tl_wr740n_v6_flash_data);
...
static void __init tl_wr740n_v6_setup(void)
{
	...
	ath79_register_gpio_keys_polled(1, TL_WR740NV6_KEYS_POLL_INTERVAL,
